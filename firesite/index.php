    ...
    <div id='containerL'>
        <form action="" method="POST" name="report_params" id="report_params"> 
            ...
            <select name="choice" id="report_choice" onchange="timeBased();">
                ...
                <option value="Time Until Dispatch">Time to Dispatch</option>
                <option value="Time Until Available">Time Available</option>
                <option value="Time Until On Scene">Time to Arrival</option>
            </select>
            </br>
